...
MODULES = [ApiKeyConfig, LithopsEndpointConfig, LithopsVPCConfig, LithopsSshKeyConfig, LithopsImageConfig, CosConfig, RuntimeConfig, DismantleConfig, LithopsProfileConfig]